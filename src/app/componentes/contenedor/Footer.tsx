      ...
      <div>
        ...
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          <div className="col-md-4 d-flex align-items-center">
            ...
            <span className="mb-0 mb-md-2 text-muted">© 2024 IPUC LA LUNA</span>
          </div>
          ...
          <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
            ...
            <li className="ms-3">
              <a className="text-muted" href="https://www.instagram.com/ipuclaluna/">
                <svg className="bi" width="24" height="24">
                  <use href="#instagram">
            ...
            <li className="ms-3">
              <a className="text-muted" href="https://www.facebook.com/ipuc.lalunamalambo">
                <svg className="bi" width="24" height="24">
                  <use href="#facebook">
